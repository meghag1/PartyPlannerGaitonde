/**
 * @author Megha Gationde
 * Jan 19 2023
 * Party Planner
 * This file has the person object declerations and getter methods
 */
...
class Person {
  ...
  public Person(int personID, String lname, String fname, int comp) {
    ...
    // then when I go through and see which table id they have then put them into
    // that table
