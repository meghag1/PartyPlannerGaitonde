...
class Main {
  ...
  public static void main(String[] args) {
    ...
    // creat while loop and quit option
    int p = 0;

    System.out.println("Hello, Welcome to the Party Planner!");
    while (p < 100) { // while loop to have it continuously asking the question
      System.out.print(
          "\nWould you like to... 1) View the current party roster, 2) Look up a table roster, 3) View the current party guest list, 4) Search up a party guest, 5) Add a party guest, 6) Print roster by company, 7) Quit program: ");
      Scanner scan = new Scanner(System.in);
      String res1 = scan.nextLine();

      // need to add some sort of functionality that will allow the methods to come
      // back to the main question above after it finishes instead of just terminating
